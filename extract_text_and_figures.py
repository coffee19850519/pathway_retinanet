...
def get_pdf_text(pdf_file):
    ...
    elif img_ed_count < img_count:  # 提取出的少于image标签的，倒数配对
        j = img_ed_count-1
    ...
    if section_tag_count == len(text_group):
        j = 0
        section_layer = ""
        section_title = ""
        temp = ""
    ...
    file = open(str(text_path) + '/' + pdf_name + '_text.json', 'w', encoding='utf-8')  # text to json file
