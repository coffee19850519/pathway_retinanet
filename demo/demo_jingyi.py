...
from predictor_jingyi import VisualizationDemo
...
def get_parser():
    ...
    parser.add_argument(
        "--input",
        # default="/mnt/data/test/img/sim_inhibit__pmc_articles_instance_3876433_bin_jkst-2-e25764-g1.png",
        nargs="+",
...
if __name__ == "__main__":
    ...
    if args.input:
        ...
        for path in tqdm.tqdm(args.input, disable=not args.output):
            ...
            # print('visualized_output',visualized_output)
            logger.info(
                "{}: {} in {:.2f}s".format(
                    path,
